...
<div class="container py-5">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex gap-2">
            {{-- Tombol Kembali ke Dashboard di Header --}}
            <a href="{{ route('dashboard') }}" class="btn btn-outline-dark btn-sm shadow-sm px-3 text-decoration-none">← Ke Dashboard</a>
            <a href="{{ route('mood') }}" class="btn btn-glass-outline btn-sm shadow-sm text-decoration-none">Ganti Mood</a>
        </div>
    </div>

    <div class="row">
        <div class="col-lg-8">
            {{-- AREA KONTEN ADAPTIF (Bisa di-scroll kebawah) --}}
...
// Output: a = 10, b = 5</code></pre>
                            ...
                            <p class="text-dark fw-medium">Gunakan logika matematika dasar untuk menukar nilai variabel tersebut di memori komputer.</p>
                        </div>
                    ...
                    @elseif($mood == 'lelah')
                        ...
                        <div class="animate-fadeIn">
                            ...
                            <p class="text-muted small">*Video berdurasi 5 menit. Santai saja, yang penting paham konsepnya.</p>
                        </div>
                    ...
                    @elseif($mood == 'bingung')
                        ...
                        <div class="animate-fadeIn">
                            ...
                            <p class="text-dark fs-5">Bayangkan <strong>Variabel</strong> adalah sebuah <strong>Gelas</strong> bermerek.</p>
                            ...
                            <p class="text-dark">Gelas jus tidak boleh diisi nasi. Begitupun variabel angka tidak boleh diisi teks!</p>
                        </div>
                    ...
                    @else
                        ...
                        <div class="animate-fadeIn">
                            ...
                            <p class="text-dark fs-5">Variabel adalah nama yang mewakili lokasi memori komputer untuk menyimpan data.</p>
                            ...
                            <p class="text-dark">Pelajari jenis-jenis tipe data dasar seperti Integer, String, dan Boolean.</p>
                        </div>
                    @endif

                    {{-- TOMBOL LANJUT MATERI (Style Outline Hitam agar sama dengan Mulai Quiz) --}}
                    <div class="mt-5 pt-4 border-top">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-muted small d-block">Topik Berikutnya:</span>
                                <h6 class="fw-bold text-dark m-0">Struktur Kontrol (If-Else)</h6>
                            </div>
                            {{-- Button Outline sesuai Dashboard --}}
                            <a href="#" class="btn btn-outline-dark px-5 py-2 fw-bold shadow-sm text-decoration-none" style="border-radius: 12px; border-width: 2px;">
                                Lanjut Materi →
                            </a>
                            <a href="#" class="btn btn-outline-dark px-5 py-2 fw-bold shadow-sm text-decoration-none" style="border-radius: 15px; border-width: 2px;">
                                Mulai Quiz
                            </a>
                        </div>
                    </div>
        ...
        <div class="col-lg-4">
            <div class="glass-box p-4 shadow-sm" style="background: rgba(255,255,255,0.9) !important; border: 1px solid rgba(0,0,0,0.1) !important;">
                ...
                <div class="card bg-dark text-white p-3 mb-4 rounded-4 border-0 shadow text-center">
                    <div class="d-flex align-items-center text-start">
                        <div class="fs-1 me-3">📝</div>
                        <div>
                            <h6 class="m-0 fw-bold text-white">Kuis Pemrograman</h6>
                            <small class="opacity-75">5 Soal Pilihan Ganda</small>
                        </div>
                    </div>
                    <a href="#" class="btn btn-light w-100 mt-3 fw-bold rounded-pill text-decoration-none text-dark">Mulai Kuis Sekarang</a>
                </div>
                ...
                <div class="mt-4 text-center">
                    {{-- Navigasi Back di bawah Sidebar --}}
...
<style>
    /* CSS UNTUK SCROLL PADA KARTU MATERI */
    .scrollable-content {
        max-height: 580px; 
        overflow-y: auto; 
